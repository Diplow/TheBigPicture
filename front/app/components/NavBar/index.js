...
const NavBar = ({ data }) => (
  <nav id="navbar" className="tbp-navbar navbar has-shadow is-spaced is-bold">
  	<div className="is-left container">
  	<a className="navbar-item tbp-logo" href="https://vue-d-ensemble.fr">
<img src="https://docs.google.com/drawings/d/e/2PACX-1vSQcstlKrXDjztL0QBJMRjsYXMwEhxlGy1pcr5RIpZp1gIEtxwtjl4QGl1jmUpImwTd3UzyEyrdeYqS/pub?w=281&amp;h=196"/>
    </a>
  	  <a className="navbar-item" href="https://github.com/Diplow/TheBigPicture">
  	  ...
  	  <a className="navbar-item" href="https://twitter.com/Diplo87355132" target="_blank">
  ...
  <a className="navbar-item" href="https://discord.gg/NtZHTqc" target="_blank">
