...
class NavBarLook extends React.Component {
        ...
        <div className="container nav-container">
          <div id="navbar" className="tbp-section level tbp-nav-level is-mobile">
            <div className="level-left is-mobile">
              <a className="tbp-logo" href="http://vue-d-ensemble.fr/home">
                <img className="tbp-logo tbp-nav-item" src="https://docs.google.com/drawings/d/e/2PACX-1vSQcstlKrXDjztL0QBJMRjsYXMwEhxlGy1pcr5RIpZp1gIEtxwtjl4QGl1jmUpImwTd3UzyEyrdeYqS/pub?w=281&amp;h=196"/>
              </a>
